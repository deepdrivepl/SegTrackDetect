...
python inference_sequence_vis.py --out_dir ablation/OBS-iou/vis/SDS-OBS-th01 \
--ds DroneCrowd --flist data/DroneCrowd/test_minus_val.txt --name test_minus_val \
--roi_model unet-DC1 \
--det_model yolov7_tiny_DC_crops \
--mode 'roi' --merge --obs_iou_th 0.1  --vis_conf_th 0.1 --debug --obs_type iou

# python inference_sequence_vis.py --out_dir ablation/OBS-iou/vis/DC-NMS-th05 \
# --ds DroneCrowd --flist data/DroneCrowd/test_minus_val.txt --name test_minus_val \
# --roi_model unet-DC1 \
# --det_model yolov7_tiny_DC_crops \
# --mode 'roi' --merge --second_nms --obs_disable --vis_conf_th 0.1 --debug


# python inference_sequence_vis.py --out_dir ablation/OBS-iou/vis/DC-OBS-th05 \
# --ds DroneCrowd --flist data/DroneCrowd/test_minus_val.txt --name test_minus_val \
# --roi_model unet-DC1 \
# --det_model yolov7_tiny_DC_crops \
# --mode 'roi' --merge --obs_iou_th 0.5  --vis_conf_th 0.1 --debug

# python inference_sequence_vis.py --out_dir ablation/OBS-iou/vis/Zebra-NMS-th03 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --obs_disable --dilate --k_size 7 --debug

# python inference_sequence_vis.py --out_dir ablation/OBS-iou/vis/Zebra-OBS-th01 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --dilate --k_size 7 --obs_iou_th 0.1 --debug


# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th09 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th08 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th07 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th06 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th05 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th04 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th03 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th02 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# python inference_sequence.py --out_dir ablation/OBS-iou/SDS-OBS-th01 \
# --ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
# --roi_model unet-SDS1 \
# --det_model yolov7_tiny_SDS_crops_mul_scales_100 \
...
# # Zebra
# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-disabled \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --obs_disable --dilate --k_size 7

# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th09 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.9

# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th08 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.8


# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th07 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.7


# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th06 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.6


# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th05 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.5


# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th04 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.4


# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th03 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.3


# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th02 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
# --mode 'roi' --merge --allow_resize --second_nms --dilate --k_size 7 --obs_iou_th 0.2


# python inference_sequence.py --out_dir ablation/OBS-iou/Zebra-OBS-th01 \
# --ds ZebraFish --flist data/3DZeF20/val.txt --name val \
