...
python inference_sequence.py --out_dir ablation/ROI-RES-VS-SW/after-fix/DC-resize-d7 \
--ds DroneCrowd --flist data/DroneCrowd/test_minus_val.txt --name test_minus_val \
--roi_model unet-DC1 \
--det_model yolov7_tiny_DC_crops \
--mode 'roi' --merge --allow_resize --dilate --k_size 7 --obs_iou_th 0.5

python inference_sequence.py --out_dir ablation/ROI-RES-VS-SW/after-fix/DC-sw-d7 \
--ds DroneCrowd --flist data/DroneCrowd/test_minus_val.txt --name test_minus_val \
--roi_model unet-DC1 \
--det_model yolov7_tiny_DC_crops \
--mode 'roi' --merge --dilate --k_size 7 --obs_iou_th 0.5

python inference_sequence.py --out_dir ablation/ROI-RES-VS-SW/after-fix/SDS-resize-d7 \
--ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
--roi_model unet-SDS1 \
--det_model yolov7_tiny_SDS_crops_mul_scales_100 \
--mode 'roi' --merge --allow_resize --dilate --k_size 7 --obs_iou_th 0.5

python inference_sequence.py --out_dir ablation/ROI-RES-VS-SW/after-fix/SDS-sw-d7 \
--ds SeaDronesSee --flist data/SeaDronesSee/test_dev.txt --name test_dev \
--roi_model unet-SDS1 \
--det_model yolov7_tiny_SDS_crops_mul_scales_100 \
--mode 'roi' --merge --dilate --k_size 7 --obs_iou_th 0.5
...
# python inference_sequence_vis.py --out_dir ablation/fix-res-sw/move-roi-extend-sw-move-sw-fix-filter-ul/DC-val-sw \
# --ds DroneCrowd --split val \
# --roi_model unet-DC1 \
# --det_model yolov7_tiny_DC_crops \
# --mode 'roi' --merge  --dilate --obs_iou_th 0.5 --k_size 7 --debug --vis_conf_th 0.1

# python inference_sequence_vis.py --out_dir ablation/fix-res-sw/move-roi-extend-sw-move-sw-fix-filter-ul/DC-val-resize \
# --ds DroneCrowd --split val \
# --roi_model unet-DC1 \
# --det_model yolov7_tiny_DC_crops \
